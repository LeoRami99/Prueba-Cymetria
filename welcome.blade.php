...
<body>
  ...
  <section id="speakers" class="speakers" style="padding-bottom: 40px;">
    <div class="container" id="talent-fest-talks">
      ...
      <!-- Prueba del card para abrir el modal -->
        <div class="col-md-3 col-sm-4 col-xs-6" style="min-height: 397.77px !important; max-height: 397.77px !important;">
          <div class="speaker-block speaker-block-active"> <img style="box-shadow: 0px 0px 17px -1px rgba(8,55,95,1);" src="images/talks/JhonatanLopez.jpg" alt="Event Premium" class="img-responsive">
            <div class="speaker-details"> <span class="speaker-name" style="font-size: 12px; margin-botton:10px;">Prueba Cymetria</span> <span class="speaker-designation">Jhonatan Andrés López</span>
              <p class="speaker-meta">Trabajo Remoto y Colaboración Virtual</p>
              <div class="social-meta">
                <a href="#Talk_7" onclick="sendViewVideo('Talk_7', 'modalPrueba')"><i class="fa fa-play-circle" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>
        </div>
        <!-- Find del card para abrir el modal -->
  ...
  <!-- Modal de la prueba -->
  <div class="annual-model-box">
    <div class="modal  fade" id="modalPrueba" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
      <div class="modal-dialog" style="margin-top:90px;" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" style="color:white;" class="close" data-dismiss="modal" aria-label="Close">
